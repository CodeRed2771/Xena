...
public class Calibration {
	...
	private final static double DT_B_ABS_ZERO_INITIAL = .166; //Practice Robot Calibration
	...
	public static final double ARM_ABS_ZERO = 0.628;  // Absolute encoder value in horizontal position
